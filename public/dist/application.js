...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleName = 'angry';
...
// Use Applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('structures');
...
function($scope, $stateParams, $location, Authentication, Items, Structures) {
	...
	$scope.addItem = function () {
		...
		{
			itm.vals.push({ title:$scope.structure.cols[i].title,value:document.getElementById($scope.structure.cols[i].title).value,category:$scope.structure.cols[i].category });
		}
